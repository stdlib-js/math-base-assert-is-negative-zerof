...
```javascript
isNegativeZerof = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-negative-zerof@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-negative-zerof@umd/bundle.js"></script>
```
