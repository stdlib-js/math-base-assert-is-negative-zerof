...
```javascript
import isNegativeZerof from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-negative-zerof@v0.1.4-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-assert-is-negative-zerof/actions/workflows/test.yml/badge.svg?branch=v0.1.4
[test-url]: https://github.com/stdlib-js/math-base-assert-is-negative-zerof/actions/workflows/test.yml?query=branch:v0.1.4
